...
const FAQS = [
  {
    q: "Does FormAssist AI officially submit forms on my behalf?",
    a: "No. FormAssist AI prepares a helper packet — a pre-filled PDF you can review, complete, and submit yourself through the appropriate official channels. We never submit anything on your behalf.",
  },
  {
  ...
  },
  {
    ...
    a: "FormAssist AI currently supports common government and administrative forms across categories like address changes, vehicle transfers, name changes, and benefits enrollment. More form types are added regularly.",
  },
  {
    q: "Is my data secure?",
  ...
  {
    q: "Do I need an account to use FormAssist AI?",
...
export default function App() {
  ...
  async function handleSignOut() { await signOut(auth); restart(); }
        ...
        <>
          <div className="fa-main">
            ...
            <div className="fa-left">
              ...
              <h1 className="fa-h1">
                Find and complete the right form — without the confusion.
              </h1>
              ...
              <div className="fa-feature-list">
                <Feature
                  ...
                  desc="No legal jargon — just describe what you need."
                />
                <Feature
                  ...
                  title="AI pre-fills the form"
                  desc="Answers are extracted from your situation automatically."
                />
                <Feature
                  ...
                  desc="Download, review, and submit through official channels."
                />
              </div>
              ...
              <div className="fa-sample-grid">
                {SAMPLE_PACKETS.map((p) => (
                  <div key={p.title} className="fa-sample-card">
                    ...
                    {p.meta.map((m) => (
                      <div key={m} className="fa-sample-meta"><span className="fa-dot" />{m}</div>
                    ))}
                  </div>
                ))}
              </div>
            ...
            <div className="fa-right">
              <div className="fa-panel-title">Start your form packet</div>
              ...
              <textarea
                id="situation" className="fa-textarea" rows={5}
              ...
              <div className="fa-chips">
                {SITUATION_CHIPS.map((chip) => (
                  <button key={chip} className="fa-chip"
              ...
              <div className="fa-consent-row">
                ...
                <label htmlFor="consent" className="fa-consent-label">
              ...
              <button className="fa-cta-btn" onClick={handleFindForms} disabled={loading}>
                Find my forms →
              </button>
        ...
        <div className="fa-main">
          <div className="fa-left">
            ...
            {recommendations.length === 0 && (
              <div className="fa-warning">No forms found. Try describing your situation with more detail.</div>
            )}
            <div className="fa-rec-list">
              {recommendations.map((form) => (
                <div key={form.form_id} className="fa-rec-card">
                  ...
                  <button className="fa-rec-select" onClick={() => chooseForm(form)} disabled={loading}>
                    Select &amp; auto-fill →
                  </button>
                </div>
              ))}
          ...
          <div className="fa-right">
            ...
            <div className="fa-panel-note">
              ...
              <button className="fa-inline-link" onClick={() => setStep("lead")}>Edit your situation</button>
            </div>
        ...
        <div className="fa-main">
          <div className="fa-left">
            ...
            <div className="fa-warning">
              Review every field. Edit anything the AI got wrong. Sensitive info (SSN, payment, signature) should be added by hand before official submission.
            </div>
            {error && <div className="fa-error">{error}</div>}
                ...
                return (
                  <div key={q.id} className={`fa-pf${isLong ? " fa-pf-full" : ""}`}>
                    <label className="fa-pf-label" htmlFor={`pf_${q.id}`}>
                      {q.label}{q.required && <span className="fa-required"> *</span>}
                    </label>
          ...
          <div className="fa-banner-grid">
            <div className="fa-banner-item">
              <div className="fa-banner-icon">
                <svg viewBox="0 0 24 24"><path d="M9 12l2 2 4-4"/><rect x="3" y="4" width="18" height="16" rx="2"/></svg>
              </div>
