...
const FAQS = [
  { q: "Does DocuLyft officially submit forms on my behalf?", a: "No. DocuLyft prepares a helper packet — a pre-filled PDF you can review, complete, and submit yourself through the appropriate official channels. We never submit anything on your behalf." },
  ...
  { q: "Can I use this for any type of form?", a: "DocuLyft currently supports common government and administrative forms across categories like address changes, vehicle transfers, name changes, and benefits enrollment. More form types are added regularly." },
  ...
  { q: "Do I need an account to use DocuLyft?", a: "You need a free account to generate form packets. This allows us to securely associate your information with your session and provide a better experience across multiple forms." },
];
      ...
      {step === "lead" && (
        <div className="fa-hero-fullbleed">
          ...
          <div className="fa-hero-content">
            <h1 className="fa-hero-h1">Forms Made Simple<br /><span className="fa-hero-accent">Ready in Minutes</span></h1>
            <p className="fa-hero-p">
  Our specialized Form Agents help you search hundreds of forms, answer simple questions, and prepare your form for review.
</p>
            ...
            <div className="fa-form-finder-row">
  <button
    className="fa-form-finder-btn"
    onClick={() => navigate("/find-form")}
  >
    <span>Not sure which form?</span>
    <strong>Get guided help</strong>
    <span className="fa-form-finder-arrow">→</span>
  </button>
</div>
